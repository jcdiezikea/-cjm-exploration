...
export const TASK_ITEMS: RoadmapTaskItem[] = [
  ...
  { id: 'miro-1',  title: 'Position instant visualisation across all IKEA touchpoints (PCMP, DCMP, app, social)', source: 'Thilek & team', status: 'roadmap', linkedCards: ['a3','a4','a6'], group: 'IBD-578', stage: 'Connect' },
  { id: 'miro-2',  title: 'GenAI room generation, style transfer & realistic product rendering',                   source: 'Thilek',        status: 'pending', linkedCards: [],            group: 'IBD-578', stage: 'Build' },
  { id: 'miro-3',  title: 'Data bridge: instant visualisation to space planning (import scenes without rework)',  source: 'Thilek',        status: 'pending', linkedCards: ['a3','a4'],   group: 'IBD-578', stage: 'Connect' },
  { id: 'miro-4',  title: 'Leverage existing IMC showrooms for quick room type visualisation',                    source: 'Team input',    status: 'pending', linkedCards: [],            group: 'IBD-578', stage: 'Build' },
  { id: 'miro-5',  title: 'Shared AI infrastructure (MCP, orchestration framework, responsible AI governance)',  source: 'Anand',         status: 'pending', linkedCards: ['a18'],       group: 'IBD-578', stage: 'Build' },
  { id: 'miro-6',  title: 'Shared Planning Knowledge & Recommendation Platform (HFK, templates, models)',        source: 'Anand',         status: 'pending', linkedCards: ['a22'],       group: 'IBD-578', stage: 'Build' },
  // IBD-653 — Home Planning (customer & co-worker)
  { id: 'miro-7',  title: 'Single shared planning engine for customer & co-worker, shareable design files',      source: 'Thilek',        status: 'roadmap', linkedCards: ['a2','a14'],  group: 'IBD-653', stage: 'Connect' },
  { id: 'miro-8',  title: 'Embed system furniture in GPC/Kreativ + conversion tracking',                         source: 'Team input',    status: 'roadmap', linkedCards: ['a1','a28'],  group: 'IBD-653', stage: 'Connect' },
  { id: 'miro-9',  title: 'Continue GPC commercial planning development based on MVP results',                   source: 'Team input',    status: 'roadmap', linkedCards: ['a26'],       group: 'IBD-653', stage: 'Empower' },
  { id: 'miro-10', title: 'Cross-team integration (Home Projects, Navigation Tool) for customer journey',        source: 'Team input',    status: 'pending', linkedCards: [],            group: 'IBD-653', stage: 'Connect' },
  { id: 'miro-11', title: 'Construction features to replicate customer home space (walls, windows, structure)',  source: 'Team input',    status: 'pending', linkedCards: ['a9'],        group: 'IBD-653', stage: 'Connect' },
  { id: 'miro-12', title: 'Shared co-worker collaboration (bundle generators, commenting, remote collab)',       source: 'Team input',    status: 'pending', linkedCards: [],            group: 'IBD-653', stage: 'Empower' },
  { id: 'miro-13', title: 'AI-powered interior design lead generation for Interior Design Services',             source: 'Daniel',        status: 'roadmap', linkedCards: ['a19'],       group: 'IBD-653', stage: 'Build' },
  { id: 'miro-14', title: 'Improve GPC planning accuracy — operations & technical drawings',                     source: 'Daniel',        status: 'pending', linkedCards: ['a26'],       group: 'IBD-653', stage: 'Empower' },
  { id: 'miro-15', title: 'Improve co-worker journey in Kreativ (quick viz, share designs with end users)',      source: 'Team input',    status: 'roadmap', linkedCards: ['a27'],       group: 'IBD-653', stage: 'Empower' },
  { id: 'miro-16', title: 'Enable room scanning in system & configuration planners',                             source: 'Team input',    status: 'pending', linkedCards: ['a8'],        group: 'IBD-653', stage: 'Connect' },
  { id: 'miro-17', title: 'Support new ranges in configuration tools (e.g. INKÖPARE)',                          source: 'Team input',    status: 'pending', linkedCards: ['a10'],       group: 'IBD-653', stage: 'Connect' },
  // IBD-754 — Unified Inter/Ingka collaboration
  { id: 'miro-18', title: 'Common technical standard and data model (Inter + Ingka)',                            source: 'Thilek',        status: 'roadmap', linkedCards: ['a35'],       group: 'IBD-754', stage: 'Govern' },
  { id: 'miro-19', title: 'Align FY27–28 roadmaps, define ownership & shared dependencies',                     source: 'Thilek',        status: 'roadmap', linkedCards: ['a34'],       group: 'IBD-754', stage: 'Govern' },
  { id: 'miro-20', title: 'Unified global Home Planning North Star + UX framework',                              source: 'Thilek',        status: 'roadmap', linkedCards: ['a35'],       group: 'IBD-754', stage: 'Govern' },
  { id: 'miro-21', title: 'Import Rex Planners into GPC for whole-room planning experience',                     source: 'Team input',    status: 'roadmap', linkedCards: ['a1'],        group: 'IBD-754', stage: 'Connect' },
  { id: 'miro-22', title: 'Shared APIs, integration patterns & home planning topology definition',               source: 'Anand',         status: 'pending', linkedCards: ['a35'],       group: 'IBD-754', stage: 'Govern' },
  { id: 'miro-23', title: 'Franchise enablement principles',                                                     source: 'Anand',         status: 'pending', linkedCards: ['a35'],       group: 'IBD-754', stage: 'Govern' },
  { id: 'miro-24', title: 'Omni-channel Planning Continuity Platform (cross-device sync, handover)',             source: 'Anand',         status: 'roadmap', linkedCards: ['a3','a4'],   group: 'IBD-754', stage: 'Connect' },
  { id: 'miro-25', title: 'INTER–INGKA Space Planner & System Configurator Integration (PAX/METOD)',            source: 'Anand',         status: 'roadmap', linkedCards: ['a1','a7'],   group: 'IBD-754', stage: 'Connect' },
  { id: 'miro-26', title: 'Shared 3D Asset & Design Exchange (IMC as golden source, metadata contracts)',       source: 'Anand',         status: 'roadmap', linkedCards: ['a15'],       group: 'IBD-754', stage: 'Build' },
  { id: 'miro-27', title: 'Conversational & Agentic Home Planning Framework',                                   source: 'Anand',         status: 'roadmap', linkedCards: ['a21'],       group: 'IBD-754', stage: 'Build' },
  { id: 'miro-28', title: 'Shared Observability, Analytics & Planning Intelligence',                            source: 'Anand',         status: 'roadmap', linkedCards: ['a28','a17'], group: 'IBD-754', stage: 'Empower' },
  { id: 'miro-29', title: 'Governance, Ownership & Capability Boundaries (forum, joint prioritisation)',        source: 'Anand',         status: 'roadmap', linkedCards: ['a35','a33'], group: 'IBD-754', stage: 'Govern' },
]
